...
public class modificarProducto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Código del producto a modificar:");

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(204, 102, 0));
        jLabel7.setText("Ingresar nuevos datos");
        ...
        panelAgregarProductoLayout.setHorizontalGroup(
            ...
            .addGroup(panelAgregarProductoLayout.createSequentialGroup()
                .addGroup(panelAgregarProductoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelAgregarProductoLayout.createSequentialGroup()
                        .addGap(248, 248, 248)
                        .addComponent(textCondicion, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(panelAgregarProductoLayout.createSequentialGroup()
                        .addGroup(panelAgregarProductoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(panelAgregarProductoLayout.createSequentialGroup()
                                .addGap(47, 47, 47)
                        ...
                        .addGroup(panelAgregarProductoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(panelAgregarProductoLayout.createSequentialGroup()
                                .addGroup(panelAgregarProductoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addGroup(panelAgregarProductoLayout.createSequentialGroup()
                    ...
                    if(textCosto.getText().equals("")){
                        ...
                        if(textPrecio.getText().equals("")){
                           JOptionPane.showMessageDialog(this,"El precio es obligatorio"); 
                            ...
                            ingresarProducto(codigo,categoria, nombre, descripcion,cantidad, costo, precio, caducidad, ubicacion,condicion);
                            /*if(textCondicion.getText().equals("")){
                                JOptionPane.showMessageDialog(this,"No se ingreso el codigo que sirve como condicion");
                            } else{
    ...
    public void ingresarProducto(String codigo,String categoria,String nombre,String descripcion,String cantidad,String costo,String precio,String caducidad,String ubicacion,String condicion){
        MDB administradorBD =  new MDB();
        String leyenda;
        leyenda= administradorBD.modificarRegistro("producto","idProducto = "+codigo+",idCategoria = "+categoria+",nombre = "+nombre+",descripcion = "+descripcion
        +",cantidad = "+cantidad+",costo = "+costo+",precio = "+precio+",caducidad = "+caducidad+",ubicacion = "+ubicacion+"","idProducto = '"+condicion+"'");
